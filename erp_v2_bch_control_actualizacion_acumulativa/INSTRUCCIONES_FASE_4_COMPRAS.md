...
interfaz corporativa. No es necesario instalar primero el ZIP anterior
...
- En **Administración → Usuarios → Editar** aparece la matriz de permisos. El
  Administrador puede cambiar cualquier casilla sin modificar el rol base.
...
Expand-Archive -Path "$env:USERPROFILE\Downloads\erp_v2_bch_control_contraste_corregido_actualizacion_acumulativa.zip" -DestinationPath "C:\erp_v2_nuevo" -Force
...
La suite ejecuta **25 pruebas** y debe terminar en `OK`. Después actualiza el
